            ...
            <v-card class="qna-card">
              ...
              <v-card-text>
                ...
                <v-row class="justify-end" style="padding-top: 55px;">
                  <v-btn class="center" style="color: white; width:600px; margin-right:50px; font-size: 15px;" color="#7A6C5B" @click="modify">Modify Completed</v-btn>
                </v-row>
              </v-card-text>
            </v-card>
          </v-col>
    ...
    methods: {
      ...
      async modify() {
        ...
        try {
          ...
          const response = await axios.post(`${process.env.VUE_APP_API_BASE_URL}/employee/qna/answer/update/${id}`, params);
